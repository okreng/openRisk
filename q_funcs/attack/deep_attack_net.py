...
################### WARNING!! CHANGE THIS WHEN MAKING NEW NETWORK!!!#################
		self.module_string = 'deep_attack_net'
		...
		# First hidden Layer
		self.dense1 = tf.layers.dense(inputs = self.features, units = 128, activation = tf.nn.tanh, use_bias = False, name = 'dense1')
		self.dense2 = tf.layers.dense(inputs = self.dense1, units = 128, activation = tf.nn.tanh, use_bias = False, name = 'dense2')
		self.dense3 = tf.layers.dense(inputs = self.dense2, units = 128,  activation = tf.nn.tanh, use_bias = False, name = 'dense3')
		self.dense4 = tf.layers.dense(inputs = self.dense2, units = 128,  activation = tf.nn.tanh, use_bias = False, name = 'dense4')
		self.dense5 = tf.layers.dense(inputs = self.dense2, units = 128,  activation = tf.nn.tanh, use_bias = False, name = 'dense5')
		self.dense6 = tf.layers.dense(inputs = self.dense2, units = 128,  activation = tf.nn.tanh, use_bias = False, name = 'dense6')
		...
		self.pre_mask_output = tf.layers.dense(inputs = self.dense6, units = self.nA, activation = None, use_bias = False, name = 'output')
